...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MealPageModule", function() { return MealPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__meal__ = __webpack_require__(624);
...
var MealPageModule = (function () {
    function MealPageModule() {
    }
    return MealPageModule;
}());
MealPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__meal__["a" /* MealPage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__meal__["a" /* MealPage */]),
        ],
    })
], MealPageModule);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MealPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(36);
...
var MealPage = (function () {
    function MealPage(navCtrl, navParams) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.foodRef = __WEBPACK_IMPORTED_MODULE_2_firebase___default.a.database().ref('/Makanan-Masak/');
        this.foodRef.on('value', function (foodList) {
            var foods = [];
            ...
            _this.loadedFoodList = foods;
        });
    }
    MealPage.prototype.initializeItems = function () {
        this.foodList = this.loadedFoodList;
    };
    MealPage.prototype.getItems = function (searchbar) {
        ...
        this.foodList = this.foodList.filter(function (v) {
            if (v.Nama && q) {
...
MealPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-meal',template:/*ion-inline-start:"C:\Users\Nizan\Desktop\angularfire2-email-authentication-master\src\pages\meal\meal.html"*/'<ion-header>\n    <ion-navbar>\n        <ion-buttons>\n            <button ion-button menuToggle>\n                 <ion-icon name="menu"></ion-icon>\n                 </button>\n        </ion-buttons>\n    </ion-navbar>\n</ion-header>\n\n\n<ion-content class="outer-content">\n    <ion-searchbar (ionInput)="getItems($event)"></ion-searchbar>\n    <ion-list>\n        <button ion-button full>\n                Calculate\n               </button>\n\n        <ion-item *ngFor="let foods of foodList">\n\n            <ion-label>\n                <h2>Name: {{ foods.Nama }}</h2>\n                <h2>Calories: {{ foods.Kalori }}</h2>\n                <h2>Kuantiti: {{foods.Kuantiti}}</h2>\n            </ion-label>\n\n            <ion-checkbox checked="false" [(ngModel)]="foods.checked" value="foods.Kalori"></ion-checkbox>\n\n        </ion-item>\n    </ion-list>\n\n\n</ion-content>'/*ion-inline-end:"C:\Users\Nizan\Desktop\angularfire2-email-authentication-master\src\pages\meal\meal.html"*/,
    }),
