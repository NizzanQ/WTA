...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__recommendation__ = __webpack_require__(627);
...
RecommendationPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__recommendation__["a" /* RecommendationPage */]),
        ],
    })
...
var RecommendationPage = (function () {
    ...
    RecommendationPage.prototype.underweight = function () {
        this.navCtrl.push('UnderweightPage');
    };
    RecommendationPage.prototype.normal = function () { };
    RecommendationPage.prototype.overweight = function () { };
    RecommendationPage.prototype.obese = function () { };
    RecommendationPage.prototype.ionViewDidLoad = function () {
        ...
        personRef.on('value', function (personSnapshot) {
            _this.myPerson = personSnapshot.val().bmitext;
        });
    };
...
RecommendationPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-recommendation',template:/*ion-inline-start:"C:\Users\Nizan\Desktop\angularfire2-email-authentication-master\src\pages\recommendation\recommendation.html"*/'<ion-header>\n    <ion-navbar>\n        <ion-buttons>\n            <button ion-button menuToggle>\n                 <ion-icon name="menu"></ion-icon>\n                 </button>\n        </ion-buttons>\n    </ion-navbar>\n</ion-header>\n\n\n<ion-content class="cards-bg social-cards">\n\n    <ion-card>\n        <ion-item>\n\n            <h2>Phewww , Your BMI Are {{this.myPerson}}</h2>\n        </ion-item>\n\n        <img src="assets/img/normal.png">\n\n        <ion-card-content>\n            <p>Normal or not , you should know some ways to be healthy in life! SCROLL DOWN!</p>\n        </ion-card-content>\n    </ion-card>\n    <button ion-button (click)="underweight()" color="secondary" full> Click if you are UNDERWEIGHT!</button>\n    <button ion-button (click)="normal()" full> Click if you are NORMAL</button>\n    <button ion-button (click)="overweight()" color="danger" full> Click if you are OVERWEIGHT!</button>\n    <button ion-button (click)="obese()" color="darc" full> Click if you are OBESE!!</button>\n</ion-content>'/*ion-inline-end:"C:\Users\Nizan\Desktop\angularfire2-email-authentication-master\src\pages\recommendation\recommendation.html"*/,
    }),
