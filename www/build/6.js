...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dashboard__ = __webpack_require__(622);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_firebase__ = __webpack_require__(471);
...
var DashboardPage = (function () {
    function DashboardPage(navCtrl, authProvider) {
    ...
    DashboardPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        var personRef = __WEBPACK_IMPORTED_MODULE_3_firebase___default.a.database().ref('/person/');
        personRef.on('value', function (personSnapshot) {
            _this.myPerson = personSnapshot.val();
        });
    };
    DashboardPage.prototype.logMeOut = function () {
        var _this = this;
        this.authProvider.logoutUser().then(function () {
            _this.navCtrl.setRoot('SliderPage');
        });
    };
...
DashboardPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["n" /* Component */])({
        selector: 'page-dashboard',template:/*ion-inline-start:"C:\Users\Nizan\Desktop\angularfire2-email-authentication-master\src\pages\dashboard\dashboard.html"*/'<ion-header>\n    <ion-navbar hideBackButton start>\n        <ion-buttons>\n            <button ion-button menuToggle>\n             <ion-icon md="md-menu"></ion-icon>\n             </button>\n        </ion-buttons>\n        <ion-buttons end>\n            <button ion-button (click)="logMeOut()">\n                 <ion-icon  md="md-power"></ion-icon>\n                 </button>\n        </ion-buttons>\n    </ion-navbar>\n</ion-header>\n\n\n<ion-content padding class="masters">\n\n    <ion-card color="primary" text-center>\n        <ion-card-header>\n            Currrent BMI SCORE\n        </ion-card-header>\n        <ion-card-content>\n            <p style="font-weight: bold; font-size: 50px; color: white;" absolute-drag text-center>\n                {{ myPerson.bmi | number : \'1.2-2\'}}\n            </p>\n        </ion-card-content>\n    </ion-card>\n\n    <ion-card color="primary" text-center>\n        <ion-card-header>\n            IDEAL WEIGHT FOR YOU\n        </ion-card-header>\n        <ion-card-content>\n            <p style="font-weight: bold; font-size: 30px; color: white;" absolute-drag text-center>\n                {{ myPerson.hamwi | number : \'1.2-2\'}}KG<br>-<br> {{ myPerson.miller | number : \'1.2-2\'}}KG\n            </p>\n        </ion-card-content>\n    </ion-card>\n\n    <ion-card color="primary" text-center>\n        <ion-card-header>\n            IDEAL CALORIES NEEDED<br>PER DAY\n        </ion-card-header>\n        <ion-card-content>\n            <p style="font-weight: bold; font-size: 30px; color: white;" absolute-drag text-center>\n                {{ myPerson.tdee | number : \'1.2-2\'}}<br>CALORIES\n            </p>\n        </ion-card-content>\n    </ion-card>\n\n</ion-content>'/*ion-inline-end:"C:\Users\Nizan\Desktop\angularfire2-email-authentication-master\src\pages\dashboard\dashboard.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__providers_auth_auth__["a" /* AuthProvider */]])
], DashboardPage);
